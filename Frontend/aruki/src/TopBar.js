...
function TopBar() {
    ...
    const { activeMode, toggleActiveMode } = useContext(ActiveModeContext);
    ...
    return (
        <div className={clsx("flex justify-between p-4", darkMode ? "bg-gray-800 text-white" : "bg-white")}>
            ...
            <div className={clsx("flex border rounded-full overflow-hidden", darkMode ? "border-gray-700" : "border-gray-300")}>
                <button 
                    className={clsx("flex-1 px-4 py-2", darkMode ? "text-gray-300 hover:bg-gray-700" : "text-gray-700 hover:bg-gray-300")}
